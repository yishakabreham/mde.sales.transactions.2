...
/**
 * This is the item provider adapter for a {@link emf.salestransactions.assignment2.Discount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiscountItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Assignment2Package.Literals.DISCOUNT__PERCENTAGE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Assignment2Package.Literals.DISCOUNT__AMOUNT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Discount_type") + " " + discount.getPercentage();
	}
