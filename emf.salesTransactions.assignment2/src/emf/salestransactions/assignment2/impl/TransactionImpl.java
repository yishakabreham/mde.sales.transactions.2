/**
 */
package emf.salestransactions.assignment2.impl;

import emf.salestransactions.assignment2.Assignment2Package;
import emf.salestransactions.assignment2.Assignment2Tables;
...
import emf.salestransactions.assignment2.LineItem;
import emf.salestransactions.assignment2.PaymentMethod;
import emf.salestransactions.assignment2.Transaction;
import emf.salestransactions.assignment2.TransactionType;
 ...
 * </p>
 * <ul>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getTransactionNumber <em>Transaction Number</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getIssuedDate <em>Issued Date</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getTransactionType <em>Transaction Type</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getPaymentMethod <em>Payment Method</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getGrandTotal <em>Grand Total</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getTotalItemsPurchased <em>Total Items Purchased</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getCashier <em>Cashier</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getLineItem <em>Line Item</em>}</li>
 *   <li>{@link emf.salestransactions.assignment2.impl.TransactionImpl#getCard <em>Card</em>}</li>
 * </ul>
 *
 * @generated
 */
